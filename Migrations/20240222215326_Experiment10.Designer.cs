...
namespace eCommerce.Migrations
{
    ...
    [Migration("20240222215326_Experiment10")]
    partial class Experiment10
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eCommerce.Models.FixedOption", b =>
                {
                    b.Property<int>("FixedOptionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasKey("FixedOptionId");

                    b.ToTable("FixedOptions");
                });

            modelBuilder.Entity("eCommerce.Models.FixedValue", b =>
                {
                    ...
                    b.HasKey("FixedValueId");

                    b.HasIndex("FixedOptionId");

                    b.ToTable("FixedValues");
                });
            ...
            modelBuilder.Entity("eCommerce.Models.FixedValue", b =>
                {
                    b.HasOne("eCommerce.Models.FixedOption", "FixedOption")
                        .WithMany()
                        .HasForeignKey("FixedOptionId");

                    b.Navigation("FixedOption");
                });
            ...
            modelBuilder.Entity("eCommerce.Models.Product", b =>
                {
                    ...
                    b.HasOne("eCommerce.Models.Gender", null)
                        .WithMany("Products")
            ...
            modelBuilder.Entity("eCommerce.Models.Value", b =>
                {
                    b.HasOne("eCommerce.Models.FixedOption", null)
                        .WithMany("Values")
                        .HasForeignKey("FixedOptionId");
